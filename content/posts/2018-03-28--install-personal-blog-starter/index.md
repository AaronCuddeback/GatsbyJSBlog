...
```
gatsby new [NEW_SITE_DIRECTORY_FOR_YOUR_BLOG] https://github.com/aaroncuddeback/GatsbyJSBlog.git
```
...
To read the whole instruction article - [How to install, setup and add new content to the personalBlog starter](https://aaroncuddeback.com/install-personal-blog-starter/) - you have to move to [Front-end web development with Aaron](https://aaroncuddeback.com) website.
